...
var BaseComponent = /** @class */ (function () {
    ...
    function () {
        var _this = this;
        this.grouped = [];
        from(this.data).pipe(groupBy(function (row) { return row[_this.groupRowsBy]; }), flatMap(function (group) { return group.pipe(reduce(function (acc, curr) { return __spread(acc, [curr]); }, [])); })).subscribe(function (row) { return _this.grouped.push(row); });
    };
    /**
     * @param {?} rowIndex
     * @return {?}
...
export { TableModule, STYLE, THEME, Event, BaseComponent as ɵb, BaseModule as ɵa, CsvExportComponent as ɵf, GlobalSearchComponent as ɵe, HeaderComponent as ɵg, PaginationComponent as ɵh, GlobalSearchPipe as ɵk, RenderPipe as ɵj, SearchPipe as ɵi, SortPipe as ɵl, ConfigService as ɵc, UtilsService as ɵd };
